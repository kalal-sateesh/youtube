...
const Sidebar = () => {
  return (
    <div className="w-auto h-[90vh] absolute sm:left-3 left-2 mt-[60px]">
      ...
      <div className="sm:px-4 px-1 py-4 sm:w-[60px] w-[40px] h-auto flex gap-2 flex-col items-center hover:cursor-pointer hover:bg-[#E5E5E5] rounded-lg">
        <div>
          <img src={ShortsIcon} alt="ShortsIcon-icon" className="w-[25px] h-[25px]" />
        </div>
      ...
      <div className="sm:px-4 px-1 py-4 sm:w-[60px] w-[45px] h-auto flex gap-2 flex-col items-center hover:cursor-pointer hover:bg-[#E5E5E5] rounded-lg">
        <div>
          <img src={SubscriptionsIcon} alt="Subscriptions-icon" className="w-[25px] h-[25px]" />
        </div>
      ...
      <div className="sm:px-4 px-1 py-4 sm:w-[60px] w-[40px] h-auto flex gap-2 flex-col items-center hover:cursor-pointer hover:bg-[#E5E5E5] rounded-lg">
        <div>
          <img src={ProfileIcon} alt="Profile-icon" className="w-[25px] h-[20px]" />
        </div>
